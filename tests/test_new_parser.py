...
print("\n=== TEST SKILLS ===")
ans, provider, status = generate_answer("What skills does the candidate have?", chunks)
print(ans)
...
print("\n=== TEST SPECIFIC MATCH (PwC) ===")
ans, provider, status = generate_answer("What did the candidate do at PwC?", chunks)
print(ans)
